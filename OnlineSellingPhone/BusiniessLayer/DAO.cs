...
namespace BusinessLayer
{
    public class DAO
    {
        ...
        public static void InsertAccount(int customer_Id, string username, string password)
        {
            using (OnlineSellingPhoneContext db = new OnlineSellingPhoneContext())
            {
        ...
        public static void AddSignUpCustomerInformation(string fname, bool gender, DateTime birthday, string username, string password, string phoneNumber)
        {
            using (OnlineSellingPhoneContext db = new OnlineSellingPhoneContext())
            {
                Customer customer = new Customer(fname, gender, birthday);
                ...
                db.Accounts.Add(new Account(username.ToLower(), password, customer_Id));
                db.SaveChanges();
