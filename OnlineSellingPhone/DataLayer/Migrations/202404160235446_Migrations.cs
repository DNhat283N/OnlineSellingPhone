namespace DataLayer.Migrations
{
    ...
    public partial class Migrations : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        userRoleEnum = c.Int(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        Customer_BirthDay = c.DateTime(nullable: false),
        ...
        {
            DropForeignKey("dbo.Staffs", "Customer_ID", "dbo.Customer");
            DropForeignKey("dbo.PhoneNumber", "Customer_ID", "dbo.Customer");
            DropForeignKey("dbo.OrderDetails", "Phone_ID", "dbo.Phone");
            DropForeignKey("dbo.OrderDetails", "Order_ID", "dbo.Orders");
            DropForeignKey("dbo.Orders", "Customer_ID", "dbo.Customer");
            DropForeignKey("dbo.Images", "Phone_ID", "dbo.Phone");
            DropForeignKey("dbo.Phone", "Manufacturer_ID", "dbo.Manufacturers");
            DropForeignKey("dbo.AddressOfCustomers", "Customer_ID", "dbo.Customer");
            DropForeignKey("dbo.AddressOfCustomers", "Address_ID", "dbo.Addresses");
            DropForeignKey("dbo.Accounts", "Customer_ID", "dbo.Customer");
